	...
	return {
		apicall:	function(options) {
			...
			*/
			...
			$.ajax({
				url: 		window.meanEngine.get('api').protocol+"://"+window.meanEngine.get('api').hostname+':'+window.meanEngine.get('api').port+'/'+api.endpoint+"/"+api.method+"/jsonp",		// static url for the API calls
				dataType: 	'jsonp',
				type:		"POST",
				data:		options.params,
